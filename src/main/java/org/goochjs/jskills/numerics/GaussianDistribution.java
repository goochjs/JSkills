...
public class GaussianDistribution {
	...
	public GaussianDistribution(double mean, double standardDeviation) {
		this(mean, standardDeviation, square(standardDeviation), 1.0 / square(standardDeviation), mean / square(standardDeviation));
	}
	...
	public static GaussianDistribution fromPrecisionMean(double precisionMean, double precision) {
		return new GaussianDistribution(precisionMean / precision, sqrt(1.0 / precision), 1.0 / precision, precision, precisionMean);
	}
	...
	public static double logRatioNormalization(GaussianDistribution numerator, GaussianDistribution denominator) {
		...
		double logSqrt2Pi = log(sqrt(2 * PI));
		return log(denominator.variance) + logSqrt2Pi - log(varianceDifference) / 2.0 + square(meanDifference) / (2 * varianceDifference);
	}
	/**
	 * <pre>
	 *               1          -(x)^2 / (2*stdDev^2)
	...
	public boolean equals(final java.lang.Object o) {
		...
		if (java.lang.Double.compare(this.getVariance(), other.getVariance()) != 0) return false;
		if (java.lang.Double.compare(this.getPrecision(), other.getPrecision()) != 0) return false;
		if (java.lang.Double.compare(this.getPrecisionMean(), other.getPrecisionMean()) != 0) return false;
		return true;
	}
	...
	public int hashCode() {
		...
		final long $variance = java.lang.Double.doubleToLongBits(this.getVariance());
		result = result * PRIME + (int)($variance >>> 32 ^ $variance);
		final long $precision = java.lang.Double.doubleToLongBits(this.getPrecision());
		result = result * PRIME + (int)($precision >>> 32 ^ $precision);
		final long $precisionMean = java.lang.Double.doubleToLongBits(this.getPrecisionMean());
